...
namespace Journey.Exception {
    ...
    public class ResourceErrorMessages {
        ...
        public static string END_DATE_TRIP_MUST_BE_GREATER_THAN_START_DATE {
            get {
                return ResourceManager.GetString("END_DATE_TRIP_MUST_BE_GREATER_THAN_START_DATE", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to The inital date of the trip must be greater than today.
        /// </summary>
        public static string START_DATE_TRIP_MUST_BE_GREATER_THAN_TODAY {
            get {
                return ResourceManager.GetString("START_DATE_TRIP_MUST_BE_GREATER_THAN_TODAY", resourceCulture);
            }
        }
